...
const ScrollConfig weatherConf  PROGMEM = {{ 0, 74, 2, WA_LEFT }, 250, false, DSP_WIDTH, 0, 4, 40 };	// Weather (погода)
...
const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 183, 1, WA_CENTER };			// VU горизонт
//const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 94, 1, WA_LEFT };			// VU вертикаль
#ifdef CPU_LOAD
...
//const VUBandsConfig bandsConf     PROGMEM = { 156, 20, 4, 1, 20, 8 };						// VU горизонт
//const VUBandsConfig bandsConf     PROGMEM = { 25, 110, 4, 1, 15, 8 };						// VU вертикаль
const VUBandsConfig bandsConf     PROGMEM = { 150, 20, TFT_FRAMEWDT, 0, 15, 8 };				//VU Boombox
