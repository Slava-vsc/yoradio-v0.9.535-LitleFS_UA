...
const ScrollConfig playlistConf   PROGMEM = {{ TFT_FRAMEWDT, 112, 2, WA_LEFT }, 140, false, MAX_WIDTH, 0, 2, 30 };
...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT, 198, 1, WA_LEFT }, 250, true, MAX_WIDTH, 0, 3, 30 };	// Weather (погода)
...
const WidgetConfig  clockConf     PROGMEM = { 0, 168, 0, WA_RIGHT };  /* 52 is a fixed font size */
const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 94, 1, WA_CENTER };
#ifdef CPU_LOAD
    const WidgetConfig  cpuConf   PROGMEM = { 75, 214, 1, WA_LEFT };
#endif
...
const VUBandsConfig bandsConf     PROGMEM = { 100, 20, 10, 2, 15, 8 };
