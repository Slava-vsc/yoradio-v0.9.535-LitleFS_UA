/*************************************************************************************
    SSD1322 256x64 displays configuration file.
...
const ScrollConfig weatherConf    PROGMEM = {{ 0, 64-12, 1, WA_LEFT }, 250, true, DSP_WIDTH/2+6, 0, 2, 25 };	// Weather (погода)
...
const WidgetConfig clockConf      PROGMEM = { 0, 57, 0, WA_RIGHT };  /* 35 is a fixed font size */
const WidgetConfig vuConf         PROGMEM = { 1, 28, 1, WA_LEFT };
#ifdef CPU_LOAD
    const WidgetConfig  cpuConf   PROGMEM = { 0, 64-12, 1, WA_LEFT };
#endif
