...
const ScrollConfig apSettConf     PROGMEM = {{ TFT_FRAMEWDT, DSP_HEIGHT-TFT_FRAMEWDT-16, 2, WA_LEFT }, 250, false, DSP_WIDTH+10, 0, 3, 25 };
...
#ifdef CPU_LOAD
    const WidgetConfig  cpuConf   PROGMEM = { TFT_FRAMEWDT, DSP_HEIGHT-TFT_FRAMEWDT-14, 1, WA_LEFT };
#endif
...
const VUBandsConfig bandsConf     PROGMEM = { 19, 90, 2, 2, 15, 8 };
