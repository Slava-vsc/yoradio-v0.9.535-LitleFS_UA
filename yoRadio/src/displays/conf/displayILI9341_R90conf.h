/*************************************************************************************
    ILI9341 240x320 displays configuration file (ROTATE_90).
    Copy this file to yoRadio/src/displays/conf/displayILI9341conf_custom.h
    and modify it
    More info on https://github.com/e2002/yoradio/wiki/Widgets#widgets-description
*************************************************************************************/

#ifndef displayILI9341_R90conf_h
#define displayILI9341_R90conf_h
...
const WidgetConfig numConf        PROGMEM = {  0, 185,  52, WA_CENTER };
...
const WidgetConfig  clockConf     PROGMEM = { TFT_FRAMEWDT, (BATTERY_ON)?166:168, 52, WA_RIGHT };  /* 52 is a fixed font size. do not change */
