...
const ScrollConfig weatherConf    PROGMEM = {{ 0, 24, 1, WA_LEFT }, 250, false, DSP_WIDTH, 0, 2, 25 };	// Weather (погода)
...
#ifdef CPU_LOAD
    const WidgetConfig  cpuConf   PROGMEM = { 0, 64, 1, WA_LEFT };
#endif
