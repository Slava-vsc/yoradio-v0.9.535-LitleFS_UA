...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT, 64-9, 1, WA_LEFT }, 250, true, MAX_WIDTH-6*4, 0, 2, 25 };	// Weather (погода)
...
#ifdef CPU_LOAD
    const WidgetConfig  cpuConf   PROGMEM = { TFT_FRAMEWDT, 64-9, 1, WA_LEFT };
#endif
