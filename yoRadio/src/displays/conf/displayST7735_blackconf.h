...
const WidgetConfig  clockConf      PROGMEM = { 5, 94, 0, WA_RIGHT }; 		/* 35 is a fixed font size. */
const WidgetConfig vuConf          PROGMEM = { TFT_FRAMEWDT, 57, 1, WA_LEFT };
const WidgetConfig bootWdtConf  PROGMEM = { 0, 90, 1, WA_CENTER };
#ifdef CPU_LOAD
    const WidgetConfig  cpuConf   PROGMEM = { 0, 108, 1, WA_LEFT };
#endif
...
const VUBandsConfig bandsConf    PROGMEM = { 13, 50, 2, 1, 10, 8 };
//const VUBandsConfig bandsConf     PROGMEM = { (MAX_WIDTH-TFT_FRAMEWDT*3)/2, 20, TFT_FRAMEWDT, 0, 15, 8 };	//Boombox
