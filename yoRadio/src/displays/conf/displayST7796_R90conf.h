/*************************************************************************************
    ST7796 320X480 displays configuration file (ROTATE_90).
    Copy this file to yoRadio/src/displays/conf/displayST7789conf_custom.h
    and modify it
    More info on https://github.com/e2002/yoradio/wiki/Widgets#widgets-description
*************************************************************************************/

#ifndef displayST7796_R90conf_h
#define displayST7796_R90conf_h
...
const VUBandsConfig bandsConf     PROGMEM = { (MAX_WIDTH/*-TFT_FRAMEWDT-TITLE_FIX-2*/)/2, 50, TFT_FRAMEWDT, 1, (!BBOX)?20:15, 8 };	//Studio/Boombox
