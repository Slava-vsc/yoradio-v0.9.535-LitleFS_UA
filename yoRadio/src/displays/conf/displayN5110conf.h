...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT, 48-11, 1, WA_LEFT }, 250, true, MAX_WIDTH-6*3-2, 1000, 5, SCROLLDELAY };	// Weather (погода)
...
const WidgetConfig clockConf      PROGMEM = { 4, 35, 0, WA_RIGHT };  /* 19 is a fixed font size */
const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 50, 1, WA_LEFT };
#ifdef CPU_LOAD
    const WidgetConfig  cpuConf   PROGMEM = { 0, 48-11, 1, WA_LEFT };
#endif
