...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT, 42, 1, WA_LEFT }, 250, true, MAX_WIDTH, 0, 3, 30 };	// Weather (погода)
...
const WidgetConfig  clockConf     PROGMEM = { 0, 94, 0, WA_RIGHT };  /* 35 is a fixed font size */
const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 99, 1, WA_CENTER };
#ifdef CPU_LOAD
    const WidgetConfig  cpuConf   PROGMEM = { TFT_FRAMEWDT, 108, 1, WA_LEFT };
#endif
...
const VUBandsConfig bandsConf     PROGMEM = { 56, 7, 2, 1, 10, 8 };
