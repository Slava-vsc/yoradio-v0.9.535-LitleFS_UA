...
const WidgetConfig  clockConf     PROGMEM = { TFT_FRAMEWDT+70, 237, 0, WA_RIGHT };  /* 70 is a fixed font size */
const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 137, 1, WA_LEFT };
#ifdef CPU_LOAD
    const WidgetConfig  cpuConf   PROGMEM = { TFT_FRAMEWDT, DSP_HEIGHT-38, 2, WA_LEFT };
#endif
...
const VUBandsConfig bandsConf     PROGMEM = { 35, 130, 4, 2, 20, 8 };
//const VUBandsConfig bandsConf     PROGMEM = { (MAX_WIDTH-TFT_FRAMEWDT*3)/2, 20, TFT_FRAMEWDT, 0, 20, 8 };	//Studio/Boombox
