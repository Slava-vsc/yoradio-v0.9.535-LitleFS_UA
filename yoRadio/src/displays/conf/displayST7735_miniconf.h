...
const ScrollConfig playlistConf   PROGMEM = {{ TFT_FRAMEWDT, 33, 1, WA_LEFT }, 140, false, MAX_WIDTH, 0, 3, 30 };
...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT, 80-13, 1, WA_LEFT }, 250, true, MAX_WIDTH-6*3, 0, 3, 30 };	// Weather (погода)
...
const WidgetConfig  clockConf     PROGMEM = { 0, 29+34, 0, WA_RIGHT };  /* 35 is a fixed font size */
const WidgetConfig vuConf         PROGMEM = { 1, 28, 1, WA_LEFT };
#ifdef CPU_LOAD
    const WidgetConfig  cpuConf   PROGMEM = { TFT_FRAMEWDT, 80-13, 1, WA_LEFT };
#endif
...
const VUBandsConfig bandsConf     PROGMEM = { 12, 48, 2, 1, 10, 8 };
