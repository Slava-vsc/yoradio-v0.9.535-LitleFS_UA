...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT, 74, 2, WA_LEFT }, 250, false, MAX_WIDTH, 0, 4, 40 };	// Weather (погода)
...
//const VUBandsConfig bandsConf   	PROGMEM = { 150, 20, 8, 1, 20, 1 };
