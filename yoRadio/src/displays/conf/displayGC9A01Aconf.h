...
const ScrollConfig apTitleConf    PROGMEM = {{ TFT_FRAMEWDT+12, TFT_FRAMEWDT+28+20, 3, WA_CENTER }, 250, false, MAX_WIDTH-24, 0, 4, 20 };
...
#ifdef CPU_LOAD
    const WidgetConfig  cpuConf   PROGMEM = { TFT_FRAMEWDT, 214, 1, WA_LEFT };
#endif
...
const VUBandsConfig bandsConf     PROGMEM = { 90, 20, 6, 2, 15, 8 };
