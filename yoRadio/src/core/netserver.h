...
<title>yoRadio - WEB Board Uploader</title><style>html, body { margin: 0; padding: 0; height: 100%; } body{background-color:#000;color:#e3d25f;font-size:20px;display:flex;flex-direction:column;}
...
<section>
<h2>yoRadio - Веб-завантажувач файлів</h2>
<hr />
<span>Виберіть <u>УСІ</u> файли з папки <i>yoRadio/data/www/</i><br />та завантажте їх за допомогою форми нижче</span>
<hr />
...
<hr />
<span>-= НЕОБОВ'ЯЗКОВО =-<br />Ви також можете завантажити файли <i>playlist.csv</i><br />та <i>wifi.csv files</i> із вашої резервної копії</span>
<p><label for="data">wifi:</label><input type="file" name="data" id="data" multiple></p>
<hr />
<p><input type="submit" name="submit" value="Завантажити"></p>
</form>
<div style="padding:10px 0 0;" id="wupload">
<hr />
<form name="wifiform" method="post" enctype="multipart/form-data">
<span>-= НЕОБОВ'ЯЗКОВО =-<br />Якщо не вдається підключитися з ПК до адреси 192.168.4.1,<br />налаштуйте спочатку Wi-Fi підключення</span>
<div class="flex"><div><label for="ssid">ssid:</label><input type="text" id="ssid" name="ssid" value="" maxlength="30" autocomplete="off"></div>
<div><label for="pass">пароль::</label><input type="password" id="pass" name="pass" value="" maxlength="40" autocomplete="off"></div>
</div>
<p><input type="submit" name="submit" value="Зберегти дані доступу"></p>
</form>
</div>
</section>
<p><a href="/emergency">аварійний завантажувач прошивки</a></p>
<div id="copy">створено на базі <a target="_blank" href="https://github.com/e2002/yoradio/">yoRadio</a><span id="version"></span></div>
</body>
<script>
